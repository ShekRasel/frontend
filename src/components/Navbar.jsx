...
const Navbar = () => {
  ...
  return (
    <nav className=" bg-slate-100 shadow-md sticky top-0 z-10 md:px-6 lg:px-16 font-serif">
      <div className="container mx-auto flex justify-between items-center p-4">
        ...
        <div className="flex items-center space-x-4 lg:gap-6 ">
          ...
          {isLoggedIn && !isOpen && (
            // Render profile photo only if the mobile menu is not open
            <>
              {profilePhoto && (
      ...
      {isOpen && (
        <div className="md:hidden bg-white shadow-md px-6">
